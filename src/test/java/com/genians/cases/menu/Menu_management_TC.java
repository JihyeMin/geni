...
@RunWith(Suite.class)
@SuiteClasses({ 
    Menu_management_01.class,
    Menu_management_02.class,
    Menu_management_03.class,
    Menu_management_04.class,
    Menu_management_05.class,
    Menu_management_06.class,
})

public class Menu_management_TC {
    ...
    public static void setUp() throws Exception {
        try {
            ...
            extentTest = extentReports.createTest("Menu_management_TC", "관리콘솔의 [관리] 메뉴를 클릭하여 페이지의 화면이 정상 표시되는지 확인한다.");
