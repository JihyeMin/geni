...
@RunWith(Suite.class)
@SuiteClasses({ 
    Menu_preferences_01.class,
    Menu_preferences_02.class,
    Menu_preferences_03.class,
    Menu_preferences_04.class,
    Menu_preferences_05.class,
})

public class Menu_preferences_TC {
    ...
    public static void setUp() throws Exception {
        try {
            ...
            extentTest = extentReports.createTest("Menu_preferences_TC", "관리콘솔의 [설정] 메뉴를 클릭하여 페이지의 화면이 정상 표시되는지 확인한다.");
