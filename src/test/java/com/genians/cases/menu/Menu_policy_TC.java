...
@RunWith(Suite.class)
@SuiteClasses({ 
    Menu_policy_01.class,
    Menu_policy_02.class,
    Menu_policy_03.class,
})

public class Menu_policy_TC {
    ...
    public static void setUp() throws Exception {
        try {
            ...
            extentTest = extentReports.createTest("Menu_policy_TC", "관리콘솔의 [정책] 메뉴를 클릭하여 페이지의 화면이 정상 표시되는지 확인한다.");
